package com.ecom.presentation;

import com.ecom.entities.Lignecommande;
import com.ecom.presentation.util.JsfUtil;
import com.ecom.presentation.util.PaginationHelper;
import com.ecom.services.LignecommandeFacade;
...
@ManagedBean(name = "lignecommandeController")
@SessionScoped
public class LignecommandeController implements Serializable {
    ...
    @EJB
    private com.ecom.services.LignecommandeFacade ejbFacade;
    ...
    public static class LignecommandeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Lignecommande) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + LignecommandeController.class.getName());
            }
        }
    }
}
