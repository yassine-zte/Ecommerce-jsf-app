...
import com.ecom.services.CommandeFacade;
...
public class CommandeController implements Serializable {
    ...
    @EJB
    private com.ecom.services.CommandeFacade ejbFacade;
    ...
    public static class CommandeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Commande) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CommandeController.class.getName());
            }
        }
    }
}
